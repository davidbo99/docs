...
<Steps>
  ...
  <Step title="Connect it to your number and set routing" icon="route">
    ...
    <Info>
      **📷 Screenshot needed** — the "WhatsApp channel" group expanded with number, type, and routing.

      Save to `/images/en/getting-started/04-channel.png`
    </Info>
  ...
  <Step title="Test it before activating" icon="flask">
    ...
    <Info>
      **📷 Screenshot needed** — the "Test" tab with a test conversation and the real-tools warning visible.

      Save to `/images/en/getting-started/05-test.png`
    </Info>
  </Step>
