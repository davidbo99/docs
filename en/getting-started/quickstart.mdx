...
<Steps>
  <Step title="Connect your WhatsApp Business account" icon="whatsapp">
    ...
    <Frame caption="The connected account, with the number showing Connected status">
      <img src="/images/en/getting-started/01-number-connected.png" alt="WhatsApp Business panel showing the connected account and the number with Connected status" />
    </Frame>
  </Step>
  <Step title="Create your agent" icon="robot">
    ...
    <Frame caption="The agent workspace: settings, prompt and side panel">
      <img src="/images/en/getting-started/02-workspace.png" alt="WhatsApp agent editor with its three columns: settings, prompt, and the Atlas, Test and Summary panel" />
    </Frame>
  </Step>
