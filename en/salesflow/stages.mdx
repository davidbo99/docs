...
{/* SCREENSHOT: the full "Edit Stage" modal, with type, color, and final-stage options
<Frame caption="Stage configuration">
  <img src="/images/en/salesflow/stages-modal.png" alt="Stage configuration modal" />
</Frame>
*/}
...
{/* SCREENSHOT: the amber "N stage(s) with no path to a final stage" warning in Flow view
<Frame caption="Warning about stages with no path to a final stage">
  <img src="/images/en/salesflow/stages-dead-end.png" alt="Dead-end stages warning" />
</Frame>
*/}
