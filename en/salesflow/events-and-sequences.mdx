...
<Frame caption="The stage events editor">
  <img src="/images/en/salesflow/events-modal.png" alt="Stage events modal showing the event list, the trigger form and the action sequence" />
</Frame>
...
<Frame caption="Two condition groups combined with OR, alongside the action's execution history">
  <img src="/images/en/salesflow/events-conditions.png" alt="Condition builder with two time-range groups combined with OR, next to the execution history panel" />
</Frame>
