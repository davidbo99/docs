...
{/* SCREENSHOT: the "Configure Transition" panel with the three trigger types visible
<Frame caption="The three trigger types">
  <img src="/images/en/salesflow/transitions-panel.png" alt="Transition configuration panel" />
</Frame>
*/}
...
{/* SCREENSHOT: a selected transition showing its draggable waypoints
<Frame caption="Waypoints on a selected transition">
  <img src="/images/en/salesflow/transitions-waypoints.png" alt="Transition waypoints" />
</Frame>
*/}
