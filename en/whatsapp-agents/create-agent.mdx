...
<Steps>
  ...
  <Step title="AI model and language" icon="microchip">
    ...
    <Frame caption="The settings column: the model group open, the rest collapsed">
      <img src="/images/en/whatsapp-agents/create-01-model.png" alt="AI Model & Responses group expanded with LLM model, response language and temperature, above the four collapsed groups" />
    </Frame>

    The model list shows the **credit cost per message** next to each option, so you can weigh
    quality against price before choosing.

    <Frame caption="Every model is priced per message, in credits">
      <img src="/images/en/whatsapp-agents/model-picker.png" alt="LLM model dropdown listing models with their credit cost per message" />
    </Frame>
  </Step>
