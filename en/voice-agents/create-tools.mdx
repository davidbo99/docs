...
<Frame caption="The tool builder, with all seven available types">
  <img src="/images/en/voice-agents/tools-builder.png" alt="Tool builder showing the API, transfer, end call, agent swap, WhatsApp template, integration and calendar types" />
</Frame>
