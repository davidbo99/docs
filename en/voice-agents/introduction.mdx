...
<Frame caption="The voice agent editor: settings, prompt and right panel">
  <img src="/images/en/voice-agents/editor-overview.png" alt="Aurora agent editor showing the settings column, the prompt document, and the Atlas, Test Call and Summary panel" />
</Frame>
