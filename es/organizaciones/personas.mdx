...
<Tabs>
  <Tab title="Tú invitas a una organización" icon="building">
    ...
    <Frame caption="Invita por correo y define el rol de cada miembro en la lista de abajo">
      <img src="/images/es/organizaciones/gestionar-usuarios.png" alt="Modal Gestionar usuarios con el campo de invitación y un miembro con su desplegable de rol Admin y el enlace Quitar" />
    </Frame>
  </Tab>
