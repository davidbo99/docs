...
<Steps>
  <Step title="Crea el pipeline" icon="plus">
    ...
    {/* SCREENSHOT: el modal de creación de pipeline con nombre y descripción
    <Frame caption="Crear un pipeline nuevo">
      <img src="/images/es/salesflow/crear-01-pipeline.png" alt="Modal de creación de pipeline" />
    </Frame>
    */}
  </Step>
  <Step title="Define las etapas" icon="layer-group">
    ...
    {/* SCREENSHOT: la vista Flujo con cuatro o cinco etapas creadas, aún sin conexiones
    <Frame caption="Las etapas del pipeline en la vista Flujo">
      <img src="/images/es/salesflow/crear-02-etapas.png" alt="Etapas en el diagrama de flujo" />
    </Frame>
    */}
  </Step>
  <Step title="Abre la puerta de entrada" icon="door-open">
    ...
    {/* SCREENSHOT: el panel "Configurar Nodo de Entrada" con tipo de fuente y condiciones
    <Frame caption="Configurar el nodo de entrada">
      <img src="/images/es/salesflow/crear-03-nodo-entrada.png" alt="Panel de configuración de nodo de entrada" />
    </Frame>
    */}
  </Step>
  <Step title="Conecta las etapas con transiciones" icon="arrow-right-arrow-left">
    ...
    {/* SCREENSHOT: el panel "Configurar Transición" mostrando los tres tipos de activador
    <Frame caption="Configurar una transición">
      <img src="/images/es/salesflow/crear-04-transicion.png" alt="Panel de configuración de transición" />
    </Frame>
    */}
  </Step>
