...
<Steps>
  ...
  <Step title="Define las etapas" icon="layer-group">
    ...
    <Frame caption="Las etapas del pipeline en la vista Flujo, aún sin conectar">
      <img src="/images/es/salesflow/crear-02-etapas.png" alt="Cuatro etapas colocadas en el diagrama sin transiciones, con el aviso de etapas sin camino a etapa final" />
    </Frame>
  </Step>
